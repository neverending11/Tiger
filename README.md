...
<a href="https://github.com/neverending11/Red-tiger.git">Dowloads "RedTiger-Tools.zip" Here</a>
...
```
1 - Open a terminal.
2 - Write "git clone https://github.com/loxyteck/Tiger-Tools.git"
3 - Write "cd Tiger-Tools"
4 - Write "git pull"
...
<p>
  tiger has been developed solely for educational purposes. This project has been created with good intentions and is intended for personal use only. By choosing to use Tiger, you acknowledge and accept full responsibility     for any consequences that may result from your actions.
</p>
